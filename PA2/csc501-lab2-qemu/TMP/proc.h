...
#define	PROC_LOCK		'\011'		/* process is in locked state */
...
extern void check_readers(int);
extern void remove_writer(int,int);
extern void swap_values(int,int);
extern void kill_lock(int);
extern int set_lock_values(int,int,int,int);
